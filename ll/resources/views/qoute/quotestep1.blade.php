...
<div class=" page-title quote-step-1 invoice-btn job-btn" style="background: #f3f3f3;">
    <div class="container">
       <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
          <a id="geographicButton2" href="#" class="ne">Geographic Information</a>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
...
<div class=" info-car  singup-form">
  <div class="container">
    ...
    <div class="row" id="info-field">
        ...
        <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">   
            <input type="text"  name="licence_plate" id="licence_plate" placeholder="Licence Plate no.">
     ...
     <div class="row">
       <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 float-left">
        <div class="comme">
          ...
          <!--<a href="{{ route('qoute-step2') }}"><button>Next Step</button></a> -->
        </div>
       </div>
     </div>
  </div>
